...
public:
    ...
    int dificultad;
    /**
     * @brief nombresjugadores Lista donde se guardara los nombres de los jugadores guardados en el archivo
     */
    int habilitados[9][9];
...
private slots:
    ...
    /**
     * @brief jugadores_archivo carga la lista nombrejugadores con los nombres de todos los usuarios que guardaron una partida
     */
