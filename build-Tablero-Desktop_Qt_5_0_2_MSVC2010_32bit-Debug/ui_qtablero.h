...
public:
    ...
    void setupUi(QMainWindow *QTablero)
    {
        ...
        gridLayoutWidget->setGeometry(QRect(9, 9, 511, 451));
        ...
        label_2->setGeometry(QRect(540, 50, 46, 13));
        label_3 = new QLabel(centralWidget);
        label_3->setObjectName(QStringLiteral("label_3"));
        label_3->setGeometry(QRect(595, 10, 101, 21));
    ...
    void retranslateUi(QMainWindow *QTablero)
    {
        ...
        label->setText(QApplication::translate("QTablero", "Puntaje :", 0));
        label_2->setText(QApplication::translate("QTablero", "Tiempo:", 0));
        label_3->setText(QApplication::translate("QTablero", "0", 0));
